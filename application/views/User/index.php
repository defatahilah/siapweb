...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <div class="card-body">
        <a href="<?= base_url('Rekap_Admin'); ?>"><button type="button" class="btn btn-primary btn-lg">
                <div class="row">
        ...
        <a href="<?= base_url('Rekap_Aplikasi'); ?>"><button type="button" class="btn btn-success btn-lg">
                <div class="row">
        ...
        <a href="<?= base_url('Rekap_Email'); ?>"><button type="button" class="btn btn-danger btn-lg">
                <div class="row">
        ...
        <a href="<?= base_url('Rekap_Website'); ?>"><button type="button" class="btn btn-warning btn-lg">
                <div class="row">
