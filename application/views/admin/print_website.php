<head>
    ...
    <title>Laporan Data Website</title>
...
<body>
    ...
    <hr class="line-title">
    <p align="center"><b>LAPORAN DATA WEBSITE</b></p>
    <table cellspacing="0" width="100%" border="1" cellspacing="0" cellpadding="3" align="center">
        ...
        <div class="card-body">
            <?php
            $no = 1;
            foreach ($website as $prow) : ?>
                <tr>
                    <td align="center"><?php echo $no++ ?></td>
                    <td><?php echo $prow->domain ?></td>
                    <td><?php echo $prow->skpd ?></td>
                    <td><?php echo $prow->namaadminweb ?></td>
                    <td align="center"><?php echo $prow->nohpadminweb ?></td>
